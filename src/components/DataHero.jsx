...
function DataHero() {
  return (
    <div id='data-home' className='px-16 flex min-h-screen w-full items-center justify-center py-28 md:px-32'>
      <div className='flex flex-col items-center justify-center gap-10 text-white'>
        ...
        className='flex max-w-[700px] flex-col items-center justify-center gap-3 text-center'>
          ...
          <p className='md:text-md text-pretty text-lg text-gray-400'>Soy un analista de datos especializado en transformar información en insights estratégicos. Utilizo herramientas avanzadas para análisis y visualización de datos.</p>
        </motion.div>
      </div>
    </div>
  )
